...
public final class SharedDataUtil {
   ...
   * exists
   */
  public <T> void setInstance(Vertx vertx, T instance) {
    getOrCreate(
        vertx,
  ...
  public <T> T getInstance(Class<T> clazz) {
    io.vertx.reactivex.core.Vertx vertx = io.vertx.reactivex.core.Vertx.currentContext().owner();
    return getInstance(vertx.getDelegate(), clazz);
  }
